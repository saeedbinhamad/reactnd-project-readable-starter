  ...
  render() {
    ...
    return (
      ...
      <div className="main-banner">
        ...
        <div className="Main">
          <br />
          <button className="btn btn-primary transition middlr"><Link to="/">return back</Link></button>
          <br/>

          <div className="middlr text-center">
            <p>sort by vote score:</p>
            <button className="btn btn-default transition" style={{margin: "20px"}} onClick={() => {this.sort_posts_byScore_asc()}}>ascending order</button>
            <button className="btn btn-default transition" style={{margin: "20px"}} onClick={() => {this.sort_posts_byScore_desc()}}>descending order</button>
          </div>
          <hr/>
